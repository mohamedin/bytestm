...
public final class ReferenceMaps implements BaselineConstants {
  ...
  ReferenceMaps(BaselineCompiledMethod cm, int[] stackHeights, byte[] localTypes/*, BuildBB buildBB*/) {
...
//	for(BasicBlock block: buildBB.basicBlocks)
//		VM.sysWrite(block==null? " -" : " " + block.getBlockNumber() + "[" + block.getStart() + ":" + block.getEnd() + "]");
//	VM.sysWriteln();
//	for(short s : buildBB.byteToBlockMap)
//		VM.sysWrite(s + " ");
//	VM.sysWriteln(">>>>>>>>>");
