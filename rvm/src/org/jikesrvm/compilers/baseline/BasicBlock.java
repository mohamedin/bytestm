...
public final class BasicBlock {
  ...
  // ends with a branch instruction
  ...
  // Goto block
  private boolean gotoBlock;
  
  // --------------- Constructor --------------------------------

  /** This should be called only from the factory. */
  BasicBlock(int startval, int bn, int methodId) {
    blockNumber = bn;
    start = startval;
    this.methodId = methodId;
    blockId = methodId * MAX_BLOCK + bn;
  }
   ...
   */
  BasicBlock(int startval, int endval, int blockNumber, int methodId) {
	this(startval, blockNumber, methodId);
    end = endval;
  ...
  public void setGotoBlock(boolean gotoBlock) {
