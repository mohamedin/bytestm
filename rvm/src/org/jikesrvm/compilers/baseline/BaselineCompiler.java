...
public abstract class BaselineCompiler extends TemplateCompilerFramework {
  ...
  protected void compile() {
    ...
    // Phase 0: Define the basic blocks
 ...
 //   buildBB.determineTheBasicBlocks(method);
    ...
    try {
      refMaps = new ReferenceMaps((BaselineCompiledMethod) compiledMethod, stackHeights, localTypes);//, buildBB);
    } finally {
      if (VM.MeasureCompilationPhases) {
