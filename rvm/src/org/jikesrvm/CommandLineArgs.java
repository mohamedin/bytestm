...
public class CommandLineArgs {
  ...
  private static final Prefix[] prefixes = {new Prefix("-classpath ", PrefixType.CLASSPATH_ARG),
                                            ...
                                            new Prefix("-X:hydra:", PrefixType.HYDRA),
  ...
  /**
   * Extract command line arguments for the Hydra VM
   * @return Java agent arguments
   */
  public static String[] getHydraArgs() {
	    return CommandLineArgs.getArgs(CommandLineArgs.PrefixType.HYDRA);
  }
