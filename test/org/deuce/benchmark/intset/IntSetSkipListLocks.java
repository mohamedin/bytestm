 ...
 * @since 0.3
 */
public class IntSetSkipListLocks implements IntSet {
...
//	private Node m_head;
	...
	public IntSetSkipListLocks(int maxLevel, double probability) {
		m_maxLevel = maxLevel;
...
//			if (update[i]==null){
//				System.out.println("WHY NLL !!!!!"+(ttt==m_level));
//				
//			}
//		}
		node = node.getForward(0);
